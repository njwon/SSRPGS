...
class MainTab:
    ...
    def load(self):
        ...
        dpg.configure_item("last_save_time", default_value=self.progress_data["hero_settings"]["lastSaveTime"])
    ...
    def gui(self):
        with dpg.child_window(
            ...
            dpg.add_input_text(label="Последнее сохранение", tag="last_save_time", callback=self.change, user_data=["hero_settings", "lastSaveTime"])
